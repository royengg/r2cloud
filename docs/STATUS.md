...
- **Local tests:** 124 Postgres/HTTP/Socket.IO, real local Git and mocked-provider tests passed. They cover ownership, access, approvals, generation checks, streaming, runtime reuse, concurrent waiting threads, shutdown, preview grants and proxy transport, screenshot access, skill parsing/pinning, interrupted snapshots, shallow Git restoration, failed downloads, worker replacement and preservation of earlier candidates after failed corrections.
